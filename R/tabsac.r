...
# Inicialização do valor total das prestações
pp <- 0

# Inicialização do valor total dos juros
jj <- 0
...
linha1 <- paste("Total geral dos juros        ==>", format(jj, nsmall = 2, width = 9, big.mark = ".", decimal.mark = ",", digits = 2))
linha2 <- paste("Total geral do financiamento ==>", format(pp, nsmall = 2, width = 9, big.mark = ".", decimal.mark = ",", digits = 2))
